...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " (" + KEY_ID + " INTEGER PRIMARY KEY, " + KEY_FNAME + " TEXT, " + KEY_LNAME + " TEXT, " + KEY_SPIN + " TEXT, " + KEY_SPIN1 + " TEXT, " + KEY_SPIN2 + " TEXT, " + KEY_CNAME + " TEXT, " + KEY_DNAME + " TEXT, " + KEY_ENAME + " TEXT)";

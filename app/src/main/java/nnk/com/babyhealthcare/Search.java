    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String r = sq.getkey8(loca);
                String r1 = sq.getkey9(loca1);
                String r2 = sq.getkey10(loca1);
                String r3 = sq.getkey11(loca1);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent in = new Intent(Search.this, VaccinationDate.class);
                startActivity(in);
            }
        });
        ...
        log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent in = new Intent(Search.this, UpTo3.class);
                startActivity(in);
            }
        });
		 /*hm.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent in=new Intent(Search.this,AgentLogin.class);
					startActivity(in);
				}
			}); */
    }

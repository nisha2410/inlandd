...
public class Addfees extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addfees);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (loca.length() != 0 && amnt.length() != 0 && tof.length() != 0 && st.length() != 0 && ps.length() != 0) {
                    int r = sq.insertData10(loca, amnt, tof, st, ps);
                    Intent i = new Intent(Addfees.this, ViewFees.class);
                    i.putExtra("n", na);
                    i.putExtra("loc", loca);
                    i.putExtra("amt", amnt);
                    i.putExtra("tof", tof);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.add_fees, menu);
        return true;
    }
}
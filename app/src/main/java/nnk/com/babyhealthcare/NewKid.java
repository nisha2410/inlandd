...
public class NewKid extends AppCompatActivity implements View.OnClickListener {
    SQLiteHelper sq;
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.length() != 0 && un.length() != 0
                    ...
                    Intent i = new Intent(NewKid.this, Kid.class);
                    startActivity(i);
                } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.new_kid, menu);
        return true;
    }

...
public class NewBaby extends AppCompatActivity implements View.OnClickListener {
    SQLiteHelper sq;
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.length() != 0 && un.length() != 0
                        ...
                        && mn.length() != 0) {
                    int r = sq.insertData1(name, un, pw, em, mn);
                    Intent i = new Intent(NewBaby.this, Baby.class);
                    startActivity(i);
                } else {
